...
const TEST_FILES=(
    ...
    (:solvers,"test_no_jump_iterative.jl"),
    (:solvers,"test_trace_deflated_shiftinvert.jl"),
    ...
    (:workflows,"test_example_plot_label_lint.jl"),
    ...
    (:analysis,"test_symmetric_kets.jl"),
    (:analysis,"test_entanglement.jl"),
    (:analysis,"test_density_moments.jl"),
    ...
    (:analysis,"test_block_entropy.jl"),
    ...
    (:workflows,"test_guided_studies.jl"),
    ...
    (:workflows,"test_progress.jl"),
    (:workflows,"test_scans.jl"),
    (:workflows,"test_scan_extensions.jl"),
    (:workflows,"test_result_outputs.jl"),
