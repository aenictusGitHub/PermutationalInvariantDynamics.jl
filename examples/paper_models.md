...
Piccitto, and Nakanishi--Sasamoto models, together with the package's public
`spin_matrices` convention. The Nakanishi--Sasamoto helper also returns the exact
balanced-gain/loss Liouvillian spectrum used as a finite-size regression
oracle.
