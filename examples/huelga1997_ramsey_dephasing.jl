...
println("Huelga Ramsey-dephasing maximum error = ",maximum_error)
...
if makie_available()
    ...
    signal_axis=M.Axis(
        ...
        title="Ramsey signal under local dephasing")
    error_axis=M.Axis(
    ...
    save_example_figure(figure, "huelga1997_ramsey_dephasing")
end
